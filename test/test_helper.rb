...
projects = [
  { id: 1, user_id: 2, stars: 5, name: "Ruby on Rails" },
  { id: 2, user_id: 1, stars: 10, name: nil },
  { id: 3, user_id: 1, stars: 9, name: nil },
  { id: 4, user_id: 3, stars: 2, name: "PostgreSQL" },
  { id: 5, user_id: 2, stars: 6, name: "Linux" }
]
